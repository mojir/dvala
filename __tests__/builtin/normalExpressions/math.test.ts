...
describe('math functions', () => {
  ...
  describe('inc', () => {
    it('samples', () => {
      ...
      expect(dvala.run('inc(1)')).toBe(2)
      expect(dvala.run('inc(0)')).toBe(1)
      expect(dvala.run('inc(-1)')).toBe(0)
      expect(dvala.run('inc(-2.5)')).toBe(-1.5)
      expect(() => dvala.run('inc()')).toThrow(DvalaError)
      expect(() => dvala.run('inc(1, 1)')).toThrow(DvalaError)
      expect(() => dvala.run('inc("1")')).toThrow(DvalaError)
      expect(() => dvala.run('inc(false)')).toThrow(DvalaError)
      expect(() => dvala.run('inc(true)')).toThrow(DvalaError)
      expect(() => dvala.run('inc(null)')).toThrow(DvalaError)
  ...
  describe('dec', () => {
    it('samples', () => {
      expect(dvala.run('dec(2.5)')).toBe(1.5)
      expect(dvala.run('dec(1)')).toBe(0)
      expect(dvala.run('dec(0)')).toBe(-1)
      expect(dvala.run('dec(-1)')).toBe(-2)
      expect(dvala.run('dec(-2.5)')).toBe(-3.5)
      expect(() => dvala.run('dec()')).toThrow(DvalaError)
      expect(() => dvala.run('dec(1, 1)')).toThrow(DvalaError)
      expect(() => dvala.run('dec("1")')).toThrow(DvalaError)
      expect(() => dvala.run('dec(false)')).toThrow(DvalaError)
      expect(() => dvala.run('dec(true)')).toThrow(DvalaError)
      expect(() => dvala.run('dec(null)')).toThrow(DvalaError)
  ...
  describe('+', () => {
    it('samples', () => {
      expect(dvala.run('+()')).toBe(0)
      expect(dvala.run('+(2, 3, 4)')).toBe(9)
      expect(dvala.run('2 + 2')).toBe(4)
      expect(dvala.run('-2 + 2')).toBe(0)
  ...
  describe('*', () => {
    it('samples', () => {
      expect(dvala.run('*()')).toBe(1)
      expect(dvala.run('*(2)')).toBe(2)
  ...
  describe('/', () => {
    it('samples', () => {
      expect(dvala.run('/()')).toBe(1)
      expect(dvala.run('/(2)')).toBe(0.5)
      expect(dvala.run('/(8, 4, 2)')).toBe(1)
      expect(dvala.run('2 / 5')).toBe(2 / 5)
      expect(dvala.run('2 / 2')).toBe(2 / 2)
      expect(dvala.run('-2 / 2')).toBe(-2 / 2)
  ...
  describe('-', () => {
    it('samples', () => {
      ...
      expect(dvala.run('-(1, 2, 3)')).toBe(1 - 2 - 3)
      expect(dvala.run('2 - 2')).toBe(2 - 2)
      expect(dvala.run('-2 - 2')).toBe(-2 - 2)
      expect(dvala.run('1 - 2 - 3 - 4')).toBe(1 - 2 - 3 - 4)
      expect(() => dvala.run('"1" - 2')).toThrow(DvalaError)
  ...
  describe('sqrt', () => {
    it('samples', () => {
      expect(() => dvala.run('sqrt()')).toThrow(DvalaError)
      expect(() => dvala.run('sqrt(3, 4)')).toThrow(DvalaError)
      expect(() => dvala.run('sqrt(-3)')).toThrow(DvalaError)
      expect(dvala.run('sqrt(0)')).toBe(0)
  ...
  describe('cbrt', () => {
    it('samples', () => {
      expect(() => dvala.run('cbrt()')).toThrow(DvalaError)
      expect(() => dvala.run('cbrt(3, 4)')).toThrow(DvalaError)
      expect(dvala.run('cbrt(-8)')).toBe(-2)
      expect(dvala.run('cbrt(0)')).toBe(0)
      expect(dvala.run('cbrt(1)')).toBe(1)
      expect(dvala.run('cbrt(8)')).toBe(2)
  ...
  describe('^', () => {
    it('samples', () => {
      ...
      expect(dvala.run('^(16, 0.5)')).toBe(4)
      expect(dvala.run('^(10, -1)')).toBe(0.1)
      expect(dvala.run('^(10, -2)')).toBe(0.01)
  ...
  describe('round', () => {
    it('samples', () => {
      expect(() => dvala.run('round()')).toThrow(DvalaError)
      expect(() => dvala.run('round(3, 4, 5)')).toThrow(DvalaError)
      expect(dvala.run('round(0)')).toBe(0)
      expect(dvala.run('round(1)')).toBe(1)
      expect(dvala.run('round(0.4)')).toBe(0)
      expect(dvala.run('round(0.5)')).toBe(1)
      expect(dvala.run('round(0.6)')).toBe(1)
      expect(dvala.run('round(-0.4)')).toBe(-0)
      expect(dvala.run('round(-0.5)')).toBe(-0)
      expect(dvala.run('round(-0.6)')).toBe(-1)
  ...
  describe('floor', () => {
    it('samples', () => {
      expect(() => dvala.run('floor()')).toThrow(DvalaError)
      expect(() => dvala.run('floor(3, 4)')).toThrow(DvalaError)
      expect(dvala.run('floor(0)')).toBe(0)
      expect(dvala.run('floor(1)')).toBe(1)
      expect(dvala.run('floor(0.4)')).toBe(0)
      expect(dvala.run('floor(0.5)')).toBe(0)
      expect(dvala.run('floor(0.6)')).toBe(0)
      expect(dvala.run('floor(-0.4)')).toBe(-1)
  ...
  describe('ceil', () => {
    it('samples', () => {
      expect(() => dvala.run('ceil()')).toThrow(DvalaError)
      expect(() => dvala.run('ceil(3, 4)')).toThrow(DvalaError)
      expect(dvala.run('ceil(0)')).toBe(0)
      expect(dvala.run('ceil(1)')).toBe(1)
      expect(dvala.run('ceil(0.4)')).toBe(1)
      expect(dvala.run('ceil(0.5)')).toBe(1)
      expect(dvala.run('ceil(0.6)')).toBe(1)
      expect(dvala.run('ceil(-0.4)')).toBe(-0)
  ...
  describe('min', () => {
    it('samples', () => {
      expect(dvala.run('1 min -2')).toBe(-2)
  ...
  describe('max', () => {
    it('samples', () => {
      expect(dvala.run('1 max -2')).toBe(1)
  ...
  describe('abs', () => {
    it('samples', () => {
      expect(dvala.run('abs(2)')).toBe(2)
      expect(dvala.run('abs(-2)')).toBe(2)
      expect(dvala.run('abs(-0)')).toBe(0)
  ...
  describe('sign', () => {
    it('samples', () => {
      expect(dvala.run('sign(2)')).toBe(1)
      expect(dvala.run('sign(-2)')).toBe(-1)
      expect(dvala.run('sign(-0)')).toBe(-0)
      expect(dvala.run('sign(0)')).toBe(0)
  ...
  describe('ln', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}ln(1)`)).toBe(Math.log(1))
      expect(mdvala.run(`${m}ln(100)`)).toBe(Math.log(100))
      expect(() => mdvala.run(`${m}ln(-2)`)).toThrow(DvalaError)
      expect(mdvala.run(`${m}ln(0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(mdvala.run(`${m}ln(-0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(() => mdvala.run(`${m}ln()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}ln(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the natural logarithm of a vector', () => {
      expect(mdvala.run(`${m}ln([1, 2, 3])`)).toEqual([0, Math.log(2), Math.log(3)])
      expect(mdvala.run(`${m}ln([0])`)).toEqual([Number.NEGATIVE_INFINITY])
    ...
    it('should take the natural logarithm of a matrix', () => {
      ...
      expect(mdvala.run(`${m}ln([[0]])`)).toEqual([[Number.NEGATIVE_INFINITY]])
      expect(mdvala.run(`${m}ln([[-1]])`)).toEqual([[Number.NaN]])
    })
  })
  ...
  describe('log2', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}log2(1)`)).toBe(Math.log2(1))
      expect(mdvala.run(`${m}log2(100)`)).toBe(Math.log2(100))
      expect(() => mdvala.run(`${m}log2(-2)`)).toThrow(DvalaError)
      expect(mdvala.run(`${m}log2(0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(mdvala.run(`${m}log2(-0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(() => mdvala.run(`${m}log2()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}log2(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the base 2 logarithm of a vector', () => {
      expect(mdvala.run(`${m}log2([1, 2, 3])`)).toEqual([0, 1, Math.log2(3)])
      expect(mdvala.run(`${m}log2([0])`)).toEqual([Number.NEGATIVE_INFINITY])
  ...
  describe('log10', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}log10(1)`)).toBe(Math.log10(1))
      expect(mdvala.run(`${m}log10(100)`)).toBe(Math.log10(100))
      expect(() => mdvala.run(`${m}log10(-2)`)).toThrow(DvalaError)
      expect(mdvala.run(`${m}log10(0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(mdvala.run(`${m}log10(-0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(() => mdvala.run(`${m}log10()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}log10(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the base 10 logarithm of a vector', () => {
      expect(mdvala.run(`${m}log10([1, 2, 3])`)).toEqual([0, Math.log10(2), Math.log10(3)])
      expect(mdvala.run(`${m}log10([0])`)).toEqual([Number.NEGATIVE_INFINITY])
  ...
  describe('trunc', () => {
    it('samples', () => {
      expect(dvala.run('trunc(0)')).toBe(0)
      expect(dvala.run('trunc(0.123)')).toBe(0)
      expect(dvala.run('trunc(0.999)')).toBe(0)
      expect(dvala.run('trunc(-0.99)')).toBe(-0)
      expect(dvala.run('trunc(-0.1)')).toBe(-0)
  ...
  describe('sin', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}sin(0.1)`)).toBe(Math.sin(0.1))
      expect(mdvala.run(`${m}sin(-0.1)`)).toBe(Math.sin(-0.1))
      expect(mdvala.run(`${m}sin(1)`)).toBe(Math.sin(1))
      expect(mdvala.run(`${m}sin(100)`)).toBe(Math.sin(100))
      expect(() => mdvala.run(`${m}sin()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}sin(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the sine of a vector', () => {
      expect(mdvala.run(`${m}sin([0, 0.1, -0.1])`)).toEqual([Math.sin(0), Math.sin(0.1), Math.sin(-0.1)])
  ...
  describe('cos', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}cos(0.1)`)).toBe(Math.cos(0.1))
      expect(mdvala.run(`${m}cos(-0.1)`)).toBe(Math.cos(-0.1))
      expect(mdvala.run(`${m}cos(1)`)).toBe(Math.cos(1))
      expect(mdvala.run(`${m}cos(100)`)).toBe(Math.cos(100))
      expect(() => mdvala.run(`${m}cos()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}cos(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the cosine of a vector', () => {
      expect(mdvala.run(`${m}cos([0, 0.1, -0.1])`)).toEqual([Math.cos(0), Math.cos(0.1), Math.cos(-0.1)])
  ...
  describe('tan', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}tan(0.1)`)).toBe(Math.tan(0.1))
      expect(mdvala.run(`${m}tan(-0.1)`)).toBe(Math.tan(-0.1))
      expect(mdvala.run(`${m}tan(1)`)).toBe(Math.tan(1))
      expect(mdvala.run(`${m}tan(100)`)).toBe(Math.tan(100))
      expect(() => mdvala.run(`${m}tan()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}tan(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the tangent of a vector', () => {
      expect(mdvala.run(`${m}tan([0, 0.1, -0.1])`)).toEqual([Math.tan(0), Math.tan(0.1), Math.tan(-0.1)])
  ...
  describe('sinh', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}sinh(0.1)`)).toBe(Math.sinh(0.1))
      expect(mdvala.run(`${m}sinh(-0.1)`)).toBe(Math.sinh(-0.1))
      expect(mdvala.run(`${m}sinh(1)`)).toBe(Math.sinh(1))
      expect(mdvala.run(`${m}sinh(100)`)).toBe(Math.sinh(100))
      expect(() => mdvala.run(`${m}sinh()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}sinh(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the hyperbolic sine of a vector', () => {
      expect(mdvala.run(`${m}sinh([0, 0.1, -0.1])`)).toEqual([Math.sinh(0), Math.sinh(0.1), Math.sinh(-0.1)])
  ...
  describe('cosh', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}cosh(0.1)`)).toBe(Math.cosh(0.1))
      expect(mdvala.run(`${m}cosh(-0.1)`)).toBe(Math.cosh(-0.1))
      expect(mdvala.run(`${m}cosh(1)`)).toBe(Math.cosh(1))
      expect(mdvala.run(`${m}cosh(100)`)).toBe(Math.cosh(100))
      expect(() => mdvala.run(`${m}cosh()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}cosh(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the hyperbolic cosine of a vector', () => {
      expect(mdvala.run(`${m}cosh([0, 0.1, -0.1])`)).toEqual([Math.cosh(0), Math.cosh(0.1), Math.cosh(-0.1)])
  ...
  describe('tanh', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}tanh(0.1)`)).toBe(Math.tanh(0.1))
      expect(mdvala.run(`${m}tanh(-0.1)`)).toBe(Math.tanh(-0.1))
      expect(mdvala.run(`${m}tanh(1)`)).toBe(Math.tanh(1))
      expect(mdvala.run(`${m}tanh(100)`)).toBe(Math.tanh(100))
      expect(() => mdvala.run(`${m}tanh()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}tanh(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the hyperbolic tangent of a vector', () => {
      expect(mdvala.run(`${m}tanh([0, 0.1, -0.1])`)).toEqual([Math.tanh(0), Math.tanh(0.1), Math.tanh(-0.1)])
  ...
  describe('asin', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}asin(0.1)`)).toBe(Math.asin(0.1))
      expect(mdvala.run(`${m}asin(-0.1)`)).toBe(Math.asin(-0.1))
      expect(mdvala.run(`${m}asin(1)`)).toBe(Math.asin(1))
      expect(() => mdvala.run(`${m}asin(100)`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}asin()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}asin(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the arcsine of a vector', () => {
      expect(mdvala.run(`${m}asin([0, 0.1, -0.1])`)).toEqual([Math.asin(0), Math.asin(0.1), Math.asin(-0.1)])
  ...
  describe('acos', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}acos(0.1)`)).toBe(Math.acos(0.1))
      expect(mdvala.run(`${m}acos(-0.1)`)).toBe(Math.acos(-0.1))
      expect(mdvala.run(`${m}acos(1)`)).toBe(Math.acos(1))
      expect(() => mdvala.run(`${m}acos(100)`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}acos()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}acos(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the arccosine of a vector', () => {
      expect(mdvala.run(`${m}acos([0, 0.1, -0.1])`)).toEqual([Math.acos(0), Math.acos(0.1), Math.acos(-0.1)])
  ...
  describe('atan', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}atan(0.1)`)).toBe(Math.atan(0.1))
      expect(mdvala.run(`${m}atan(-0.1)`)).toBe(Math.atan(-0.1))
      expect(mdvala.run(`${m}atan(1)`)).toBe(Math.atan(1))
      expect(mdvala.run(`${m}atan(100)`)).toBe(Math.atan(100))
      expect(() => mdvala.run(`${m}atan()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}atan(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the arctangent of a vector', () => {
      expect(mdvala.run(`${m}atan([0, 0.1, -0.1])`)).toEqual([Math.atan(0), Math.atan(0.1), Math.atan(-0.1)])
  ...
  describe('asinh', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}asinh(0.1)`)).toBe(Math.asinh(0.1))
      expect(mdvala.run(`${m}asinh(-0.1)`)).toBe(Math.asinh(-0.1))
      expect(mdvala.run(`${m}asinh(1)`)).toBe(Math.asinh(1))
      expect(mdvala.run(`${m}asinh(100)`)).toBe(Math.asinh(100))
      expect(() => mdvala.run(`${m}asinh()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}asinh(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the hyperbolic arcsine of a vector', () => {
      expect(mdvala.run(`${m}asinh([0, 0.1, -0.1])`)).toEqual([Math.asinh(0), Math.asinh(0.1), Math.asinh(-0.1)])
  ...
  describe('acosh', () => {
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}acosh(100)`)).toBe(Math.acosh(100))
      expect(() => mdvala.run(`${m}acosh(0.1)`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}acosh(-0.1)`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}acosh(0)`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}acosh()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}acosh(1, 2)`)).toThrow(DvalaError)
    })
    it('should take the hyperbolic arccosine of a vector', () => {
      expect(mdvala.run(`${m}acosh([1, 100])`)).toEqual([Math.acosh(1), Math.acosh(100)])
      expect(mdvala.run(`${m}acosh([])`)).toEqual([])
    })
    it('should take the hyperbolic arccosine of a matrix', () => {
      expect(mdvala.run(`${m}acosh([[1, 100], [0.1, -0.1]])`)).toEqual([[Math.acosh(1), Math.acosh(100)], [Math.acosh(0.1), Math.acosh(-0.1)]])
      expect(mdvala.run(`${m}acosh([[0]])`)).toEqual([[Math.acosh(0)]])
    })
  })
  describe('atanh', () => {
    const mdvala = new Dvala({ modules: [mathUtilsModule] })
    ...
    it('samples', () => {
      ...
      expect(mdvala.run(`${m}atanh(0.1)`)).toBe(Math.atanh(0.1))
      expect(mdvala.run(`${m}atanh(-0.1)`)).toBe(Math.atanh(-0.1))
      expect(mdvala.run(`${m}atanh(1)`)).toBe(Number.POSITIVE_INFINITY)
      expect(() => mdvala.run(`${m}atanh(100)`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}atanh()`)).toThrow(DvalaError)
      expect(() => mdvala.run(`${m}atanh(1, 2)`)).toThrow(DvalaError)
    })
  })

  describe('quot', () => {
    it('samples', () => {
      expect(dvala.run('quot(13.75, 3.25)')).toBe(4)
      expect(dvala.run('quot(-13.75, 3.25)')).toBe(-4)
      expect(dvala.run('quot(13.75, -3.25)')).toBe(-4)
      expect(dvala.run('quot(-13.75, -3.25)')).toBe(4)
      expect(() => dvala.run('quot()')).toThrow(DvalaError)
  ...
  describe('mod', () => {
    it('samples', () => {
      expect(() => dvala.run('mod()')).toThrow(DvalaError)
      expect(() => dvala.run('mod(3)')).toThrow(DvalaError)
      expect(() => dvala.run('mod(3, 4, 5)')).toThrow(DvalaError)
      expect(dvala.run('3 mod 2')).toBe(1)
      expect(dvala.run('mod(13.75, 3.25)')).toBe(0.75)
      expect(dvala.run('mod(-13.75, 3.25)')).toBe(2.5)
      expect(dvala.run('mod(13.75, -3.25)')).toBe(-2.5)
      expect(dvala.run('mod(-13.75, -3.25)')).toBe(-0.75)
      expect(dvala.run('mod(2, 1)')).toBe(0)
      expect(dvala.run('mod(2, 2)')).toBe(0)
      expect(dvala.run('mod(3, 2)')).toBe(1)
      expect(dvala.run('mod(3, -2)')).toBe(-1)
      expect(dvala.run('mod(-3, -2)')).toBe(-1)
      expect(dvala.run('mod(-3, 2)')).toBe(1)
  ...
  describe('%', () => {
    it('samples', () => {
      expect(dvala.run('13.75 % 3.25')).toBe(0.75)
      expect(dvala.run('-13.75 % 3.25')).toBe(-0.75)
      expect(dvala.run('%(13.75, 3.25)')).toBe(0.75)
      expect(dvala.run('%(-13.75, 3.25)')).toBe(-0.75)
      expect(dvala.run('%(-13.75, 3.25)')).toBe(-0.75)
