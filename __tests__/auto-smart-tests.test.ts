...
describe('auto: arg names validation (modules)', () => {
  ...
  const reservedWords = new Set(['if', 'then', 'else', 'end', 'do', 'let', 'for', 'in', 'loop', 'recur', 'case', 'try', 'catch', 'throw', 'import', 'as', 'true', 'false', 'null', 'and', 'or', 'not', 'when', 'match', 'with', 'def', 'defined?'])
