...
import { assertRegularExpression, assertStringOrRegularExpression, isRegularExpression } from '@mojir/dvala-types'
import { assertString, isString } from '@mojir/dvala-types'
