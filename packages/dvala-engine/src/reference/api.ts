export { categories, coreCategoryDescriptions, coreCategories, isDataType } from '../builtin/interface'
export type { Category, DataType } from '../builtin/interface'
...
const api = {
  ...
  assertionUtils: [
    ...
    'assertion.assertFails',
    'assertion.assertFailsWith',
    'assertion.assertSucceeds',
