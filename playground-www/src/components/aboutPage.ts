...
<div class="content-page about-page">
  ...
  <div class="about-intro">
    <p class="about-intro__text">
      Dvala is a suspendable runtime for JavaScript applications.
      Programs pause mid-execution, serialize to JSON, and resume anywhere — across processes, machines, and time.
    </p>
  </div>
