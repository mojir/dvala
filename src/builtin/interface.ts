...
export const moduleCategories: Category[] = ['assertion', 'bitwise', 'collection', 'convert', 'functional', 'grid', 'effectHandler', 'json', 'linearAlgebra', 'math', 'matrix', 'numberTheory', 'sequence', 'string', 'time', 'vector']
