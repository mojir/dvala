...
export const moduleCategories: Category[] = ['assertion', 'ast', 'bitwise', 'collection', 'convert', 'functional', 'grid', 'effectHandler', 'json', 'linearAlgebra', 'math', 'matrix', 'numberTheory', 'sequence', 'string', 'time', 'vector']
