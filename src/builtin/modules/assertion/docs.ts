...
export const moduleDocs: Record<string, FunctionDocs> = {
  ...
  'assertLt': {
    ...
    examples: [
      'let { assertLt } = import(assertion);\ndo with handler @dvala.error(arg) -> resume(arg) end; assertLt(1, 0, "Expected smaller value value") end',
  ...
  'assertLte': {
    ...
    examples: [
      'let { assertLte } = import(assertion);\ndo with handler @dvala.error(arg) -> resume(arg) end; assertLte(1, 0, "Expected smaller value value") end',
  ...
  'assertFalsy': {
    ...
    examples: [
      ...
      'let { assertFalsy } = import(assertion);\ndo with handler @dvala.error(arg) -> resume(arg) end; assertFalsy(nd) end',
  ...
  'assertNull': {
    ...
    examples: [
      ...
      'let { assertNull } = import(assertion);\ndo with handler @dvala.error(arg) -> resume(arg) end; assertNull(nd) end',
  ...
  'assertFailsWith': {
    ...
    examples: [
      'let { assertFailsWith } = import(assertion);\ndo with handler @dvala.error(arg) -> resume(arg) end; assertFailsWith(-> perform(@dvala.error, "Error"), "Error") end',
