...
describe('gini-coefficient', () => {
  it('should calculate gini-coefficient of a vector', () => {
    ...
    expect(() => runVec('gini-coefficient([-1, 0, 0])')).toThrow(DvalaError)
    expect(() => runVec('gini-coefficient([])')).toThrowError(DvalaError)
  })
  it('should calculate the moving gini-coefficient of a vector', () => {
    ...
    expect(() => runVec('moving-gini-coefficient([], 2)')).toThrowError(DvalaError)
  })
  it('should calculate the centered moving gini-coefficient of a vector with padding', () => {
    ...
    expect(() => runVec('centered-moving-gini-coefficient([], 2)')).toThrowError(DvalaError)
  })
  it('should calculate the running gini-coefficient of a vector', () => {
    ...
    expect(() => runVec('running-gini-coefficient([])')).toThrowError(DvalaError)
  })
})
