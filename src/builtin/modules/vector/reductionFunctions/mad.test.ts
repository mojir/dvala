...
describe('mad', () => {
  ...
  it('should calculate the moving mean absolute deviation of a vector', () => {
    ...
    expect(() => runVec('moving-mad([1], 100)')).toThrow(DvalaError)
    expect(() => runVec('moving-mad([], 1)')).toThrowError(DvalaError)
  })
  it('should calculate the centered moving mean absolute deviation of a vector with padding', () => {
    ...
    expect(() => runVec('centered-moving-mad([1], 100)')).toThrow(DvalaError)
    expect(() => runVec('centered-moving-mad([], 1)')).toThrowError(DvalaError)
  })
  it('should calculate the running mean absolute deviation of a vector', () => {
    ...
    expect(() => runVec('running-mad([])')).toThrowError(DvalaError)
  })
})
