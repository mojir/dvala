...
describe('variance functions', () => {
  describe('variance', () => {
    ...
    it('should calculate the running variance of a vector', () => {
      ...
      expect(() => runVec('running-variance([])')).toThrowError(DvalaError)
    })
  })
  ...
  describe('sample-variance', () => {
    it('should calculate the sample variance of a vector', () => {
      ...
      expect(() => runVec('sample-variance([0])')).toThrowError(DvalaError)
      expect(() => runVec('sample-variance([])')).toThrowError(DvalaError)
    })
    ...
    it('should calculate the centered moving sample variance of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-sample-variance([1, 2, 4], 1)')).toThrowError(DvalaError)
    })
    it('should calculate the running sample variance of a vector', () => {
      ...
      expect(() => runVec('running-sample-variance([2])')).toThrowError(DvalaError)
      expect(() => runVec('running-sample-variance([1])')).toThrowError(DvalaError)
    })
  })
})
