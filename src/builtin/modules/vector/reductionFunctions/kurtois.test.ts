...
describe('kurtios functions', () => {
  describe('kurtosis', () => {
    ...
    it('should calculate the moving kurtosis of a vector', () => {
      ...
      expect(() => runVec('moving-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving kurtosis of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the running kurtosis of a vector', () => {
      ...
      expect(() => runVec('running-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
  })
  describe('sample-kurtosis', () => {
    it('should calculate the sample kurtosis of a vector', () => {
      ...
      expect(() => runVec('sample-kurtosis([1, 1, 1, 1])')).toThrowError(DvalaError)
      expect(() => runVec('sample-kurtosis([0, 1])')).toThrowError(DvalaError)
      expect(() => runVec('sample-kurtosis([])')).toThrowError(DvalaError)
    })
    it('should calculate the moving sample kurtosis of a vector', () => {
      ...
      expect(() => runVec('moving-sample-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving sample kurtosis of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-sample-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the running sample kurtosis of a vector', () => {
      ...
      expect(() => runVec('running-sample-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
  })
  describe('excess-kurtosis', () => {
    it('should calculate the excess kurtosis of a vector', () => {
      ...
      expect(() => runVec('excess-kurtosis([1, 1, 1, 1])')).toThrowError(DvalaError)
      expect(() => runVec('excess-kurtosis([0, 1])')).toThrowError(DvalaError)
      expect(() => runVec('excess-kurtosis([])')).toThrowError(DvalaError)
    })
    it('should calculate the moving excess kurtosis of a vector', () => {
      ...
      expect(() => runVec('moving-excess-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving excess kurtosis of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-excess-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the running excess kurtosis of a vector', () => {
      ...
      expect(() => runVec('running-excess-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
  })
  describe('sample-excess-kurtosis', () => {
    it('should calculate the sample excess kurtosis of a vector', () => {
      ...
      expect(() => runVec('sample-excess-kurtosis([1, 1, 1, 1])')).toThrowError(DvalaError)
      expect(() => runVec('sample-excess-kurtosis([0, 1])')).toThrowError(DvalaError)
      expect(() => runVec('sample-excess-kurtosis([])')).toThrowError(DvalaError)
    })
    it('should calculate the moving sample excess kurtosis of a vector', () => {
      ...
      expect(() => runVec('moving-sample-excess-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving sample excess kurtosis of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-sample-excess-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
    it('should calculate the running sample excess kurtosis of a vector', () => {
      ...
      expect(() => runVec('running-sample-excess-kurtosis([1, 2, 3], 3)')).toThrowError(DvalaError)
    })
  })
})
