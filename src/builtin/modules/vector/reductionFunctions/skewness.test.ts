...
describe('skewness functions', () => {
  describe('skewness', () => {
    ...
    it('should calculate the moving skewness of a vector', () => {
      ...
      expect(() => runVec('moving-skewness([1, 2], 2)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving skewness of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-skewness([1, 2], 2)')).toThrowError(DvalaError)
    })
    it('should calculate the running skewness of a vector', () => {
      ...
      expect(() => runVec('running-skewness([1, 2])')).toThrowError(DvalaError)
    })
  })
  describe('sample-skewness', () => {
    it('should calculate the skewness of a vector', () => {
      ...
      expect(() => runVec('sample-skewness([1, 1, 1, 1])')).toThrowError(DvalaError)
      expect(() => runVec('sample-skewness([0, 1])')).toThrowError(DvalaError)
      expect(() => runVec('sample-skewness([])')).toThrowError(DvalaError)
    })
    it('should calculate the moving sample skewness of a vector', () => {
      ...
      expect(() => runVec('moving-sample-skewness([1, 2], 2)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving sample skewness of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-sample-skewness([1, 2], 2)')).toThrowError(DvalaError)
    })
    it('should calculate the running sample skewness of a vector', () => {
      ...
      expect(() => runVec('running-sample-skewness([1, 2])')).toThrowError(DvalaError)
    })
  })
})
