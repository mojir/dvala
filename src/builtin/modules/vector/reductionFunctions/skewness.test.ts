...
describe('skewness functions', () => {
  describe('skewness', () => {
    ...
    it('should calculate the centered moving skewness of a vector with padding', () => {
      expect(runVec('centeredMovingSkewness([1, 2, 4, 7, 11], 4)')).toEqual([
        null,
        null,
        0.4987837491108398,
        0.3461680709723672,
    ...
    it('should calculate the running skewness of a vector', () => {
      expect(runVec('runningSkewness([1, 2, 4, 7, 11])')).toEqual([
        null,
        null,
        0.38180177416060584,
        0.4987837491108398,
  ...
  describe('sampleSkewness', () => {
    ...
    it('should calculate the centered moving sample skewness of a vector with padding', () => {
      expect(runVec('centeredMovingSampleSkewness([1, 2, 4, 7, 11, 16], 4)')).toEqual([
        null,
        null,
        0.8639187954496621,
        0.5995806868822491,
    ...
    it('should calculate the running sample skewness of a vector', () => {
      expect(runVec('runningSampleSkewness([1, 2, 4, 7, 11])')).toEqual([
        null,
        null,
        0.9352195295828237,
        0.8639187954496621,
