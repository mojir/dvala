...
describe('mean functions', () => {
  describe('mean', () => {
    ...
    it('should calculate the running mean of a vector', () => {
      ...
      expect(() => runVec('running-mean([])')).toThrowError(DvalaError)
    })
  })
  describe('geometric-mean', () => {
    it('should calculate the geometric mean of a vector', () => {
      ...
      expect(() => runVec('geometric-mean([])')).toThrowError(DvalaError)
    })
    it('should calculate the moving geometric mean of a vector', () => {
      ...
      expect(() => runVec('moving-geometric-mean([1, -2, -3], 2)')).toThrow(DvalaError)
      expect(() => runVec('moving-geometric-mean([1], 100)')).toThrow(DvalaError)
      expect(() => runVec('moving-geometric-mean([], 1)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving geometric mean of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-geometric-mean([1, -2, -3], 2)')).toThrow(DvalaError)
      expect(() => runVec('centered-moving-geometric-mean([1], 100)')).toThrow(DvalaError)
      expect(() => runVec('centered-moving-geometric-mean([], 1)')).toThrowError(DvalaError)
    })
    it('should calculate the running geometric mean of a vector', () => {
      ...
      expect(() => runVec('running-geometric-mean([])')).toThrowError(DvalaError)
      expect(() => runVec('running-geometric-mean([1, -2, -3])')).toThrow(DvalaError)
    })
  })
  describe('harmonic-mean', () => {
    it('should calculate the harmonic mean of a vector', () => {
      ...
      expect(() => runVec('harmonic-mean([])')).toThrowError(DvalaError)
    })
    it('should calculate the moving harmonic mean of a vector', () => {
      ...
      expect(() => runVec('moving-harmonic-mean([1], 100)')).toThrow(DvalaError)
      expect(() => runVec('moving-harmonic-mean([], 1)')).toThrowError(DvalaError)
    })
    it('should calculate the centered moving harmonic mean of a vector with padding', () => {
      ...
      expect(() => runVec('centered-moving-harmonic-mean([1], 100)')).toThrow(DvalaError)
      expect(() => runVec('centered-moving-harmonic-mean([], 1)')).toThrowError(DvalaError)
    })
    it('should calculate the running harmonic mean of a vector', () => {
      ...
      expect(() => runVec('running-harmonic-mean([])')).toThrowError(DvalaError)
      expect(() => runVec('running-harmonic-mean([1], 100)')).toThrow(DvalaError)
    })
  })
})
