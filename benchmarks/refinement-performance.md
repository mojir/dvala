...
| Measurement | `bae472e8` (2026-04-25) | `7a67807c` (2026-04-25) | `7a67807c` (2026-04-25) | `966faea2` (2026-04-25) | `1d812f61` (2026-04-24) | `b02f24d2` (2026-04-24) | `bf6a2b1d` (2026-04-24) | `da6072a2` (2026-04-24) | `5cb1a5b2` (2026-04-23) | `6c025631` (2026-04-22) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
| typecheck: plain (no annotation) | 0.007 ms | 0.010 ms | 0.006 ms | — | 0.008 ms | 0.007 ms | 0.008 ms | 0.008 ms | 0.007 ms | 0.007 ms |
| typecheck: typed Number annotation | 0.007 ms | 0.007 ms | 0.007 ms | — | 0.007 ms | 0.007 ms | 0.008 ms | 0.008 ms | 0.007 ms | 0.006 ms |
...
| Measurement | `bae472e8` (2026-04-25) | `7a67807c` (2026-04-25) | `7a67807c` (2026-04-25) | `966faea2` (2026-04-25) | `1d812f61` (2026-04-24) | `b02f24d2` (2026-04-24) | `bf6a2b1d` (2026-04-24) | `da6072a2` (2026-04-24) | `5cb1a5b2` (2026-04-23) | `6c025631` (2026-04-22) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| interval target — Number → {n \| n > 0 && n < 100} | 0.09 μs | 0.08 μs | 0.08 μs | 0.10 μs | — | — | — | — | — | — |
| set target — :ok → {x \| :ok \| :error} | 0.12 μs | 0.12 μs | 0.12 μs | 0.12 μs | — | — | — | — | — | — |
| count target — String → {s \| count(s) > 0} | 0.05 μs | 0.05 μs | 0.05 μs | 0.05 μs | — | — | — | — | — | — |
| excludedSet — Number → {n \| !=0 && !=1 && !=-1} | 0.21 μs | 0.20 μs | 0.20 μs | 0.20 μs | — | — | — | — | — | — |
| literal source — 50 → {n \| n > 0 && n < 100} | 0.10 μs | 0.10 μs | 0.10 μs | 0.10 μs | — | — | — | — | — | — |
...
| Measurement | `bae472e8` (2026-04-25) | `7a67807c` (2026-04-25) | `7a67807c` (2026-04-25) | `966faea2` (2026-04-25) | `1d812f61` (2026-04-24) | `b02f24d2` (2026-04-24) | `bf6a2b1d` (2026-04-24) | `da6072a2` (2026-04-24) | `5cb1a5b2` (2026-04-23) | `6c025631` (2026-04-22) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 2 stacked refinements | 0.78 μs | 0.78 μs | 0.79 μs | 0.83 μs | — | — | — | — | — | — |
| N= 4 stacked refinements | 3.30 μs | 3.28 μs | 3.33 μs | 3.54 μs | — | — | — | — | — | — |
| N= 8 stacked refinements | 14.23 μs | 14.20 μs | 14.42 μs | 14.54 μs | — | — | — | — | — | — |
| N=16 stacked refinements | 88.34 μs | 86.33 μs | 88.51 μs | 85.98 μs | — | — | — | — | — | — |
| N=32 stacked refinements | 459.83 μs | 454.07 μs | 464.89 μs | 455.12 μs | — | — | — | — | — | — |
...
| Measurement | `bae472e8` (2026-04-25) | `7a67807c` (2026-04-25) | `7a67807c` (2026-04-25) | `966faea2` (2026-04-25) | `1d812f61` (2026-04-24) | `b02f24d2` (2026-04-24) | `bf6a2b1d` (2026-04-24) | `da6072a2` (2026-04-24) | `5cb1a5b2` (2026-04-23) | `6c025631` (2026-04-22) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 10 (parse + simplify) | 28.48 μs | 27.56 μs | 27.12 μs | 27.36 μs | — | — | — | — | — | — |
| N= 50 (parse + simplify) | 175.54 μs | 170.46 μs | 175.72 μs | 173.19 μs | — | — | — | — | — | — |
| N=100 (parse + simplify) | 431.79 μs | 417.76 μs | 429.83 μs | 427.16 μs | — | — | — | — | — | — |
