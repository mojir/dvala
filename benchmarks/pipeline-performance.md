...
| Measurement | `69d1b637` (2026-06-20) | `f508e714` (2026-06-20) | `eba91518` (2026-06-17) | `8e6399cb` (2026-06-13) | `c31a00e7` (2026-06-12) | `e7f35d94` (2026-06-12) | `fc2cb805` (2026-06-12) | `508c8a21` (2026-06-11) | `bfb86828` (2026-06-11) | `9d65b8a2` (2026-06-11) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| interval target — Number → {n \| n > 0 && n < 100} | 0.22 μs | 0.23 μs | 0.22 μs | 0.22 μs | 0.23 μs | 0.23 μs | 0.22 μs | 0.22 μs | 0.22 μs | 0.23 μs |
| set target — :ok → {x \| :ok \| :error} | 0.10 μs | 0.10 μs | 0.10 μs | 0.10 μs | 0.10 μs | 0.10 μs | 0.10 μs | 0.09 μs | 0.09 μs | 0.10 μs |
| count target — String → {s \| count(s) > 0} | 0.26 μs | 0.25 μs | 0.25 μs | 0.26 μs | 0.26 μs | 0.26 μs | 0.26 μs | 0.26 μs | 0.24 μs | 0.25 μs |
| excludedSet — Number → {n \| !=0 && !=1 && !=-1} | 0.17 μs | 0.17 μs | 0.16 μs | 0.17 μs | 0.17 μs | 0.17 μs | 0.16 μs | 0.17 μs | 0.16 μs | 0.17 μs |
| literal source — 50 → {n \| n > 0 && n < 100} | 0.09 μs | 0.09 μs | 0.09 μs | 0.09 μs | 0.09 μs | 0.10 μs | 0.09 μs | 0.09 μs | 0.08 μs | 0.09 μs |
...
| Measurement | `69d1b637` (2026-06-20) | `f508e714` (2026-06-20) | `eba91518` (2026-06-17) | `8e6399cb` (2026-06-13) | `c31a00e7` (2026-06-12) | `e7f35d94` (2026-06-12) | `fc2cb805` (2026-06-12) | `508c8a21` (2026-06-11) | `bfb86828` (2026-06-11) | `9d65b8a2` (2026-06-11) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 2 stacked refinements | 0.52 μs | 0.52 μs | 0.55 μs | 0.51 μs | 0.49 μs | 0.48 μs | 0.50 μs | 0.53 μs | 0.61 μs | 0.62 μs |
| N= 4 stacked refinements | 1.47 μs | 1.48 μs | 1.38 μs | 1.45 μs | 1.48 μs | 1.49 μs | 1.45 μs | 1.48 μs | 1.41 μs | 1.48 μs |
| N= 8 stacked refinements | 5.19 μs | 5.37 μs | 5.08 μs | 5.09 μs | 5.29 μs | 5.19 μs | 5.16 μs | 5.24 μs | 5.10 μs | 5.35 μs |
| N=16 stacked refinements | 28.11 μs | 29.01 μs | 28.05 μs | 28.20 μs | 29.06 μs | 28.42 μs | 28.20 μs | 28.06 μs | 28.39 μs | 29.85 μs |
| N=32 stacked refinements | 130.10 μs | 133.64 μs | 128.36 μs | 130.21 μs | 133.01 μs | 131.18 μs | 130.06 μs | 130.41 μs | 131.22 μs | 136.53 μs |
...
| Measurement | `69d1b637` (2026-06-20) | `f508e714` (2026-06-20) | `eba91518` (2026-06-17) | `8e6399cb` (2026-06-13) | `c31a00e7` (2026-06-12) | `e7f35d94` (2026-06-12) | `fc2cb805` (2026-06-12) | `508c8a21` (2026-06-11) | `bfb86828` (2026-06-11) | `9d65b8a2` (2026-06-11) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 10 (parse + simplify) | 15.74 μs | 15.34 μs | 15.06 μs | 15.19 μs | 15.06 μs | 15.81 μs | 15.31 μs | 15.34 μs | 15.49 μs | 16.98 μs |
| N= 50 (parse + simplify) | 84.33 μs | 84.19 μs | 79.94 μs | 88.34 μs | 82.04 μs | 84.69 μs | 83.09 μs | 83.82 μs | 82.29 μs | 88.77 μs |
| N=100 (parse + simplify) | 177.16 μs | 184.21 μs | 171.70 μs | 178.39 μs | 176.39 μs | 190.88 μs | 177.03 μs | 177.58 μs | 175.59 μs | 188.02 μs |
