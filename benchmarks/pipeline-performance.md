...
| Measurement | `70310733` (2026-05-28) | `8cda5a15` (2026-05-28) | `476a5eef` (2026-05-27) | `90571f50` (2026-05-27) | `90571f50` (2026-05-27) | `dd6cfd53` (2026-05-26) | `9a6c955a` (2026-05-26) | `4b3374b0` (2026-05-26) | `585579cb` (2026-05-26) | `18b49784` (2026-05-26) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| interval target — Number → {n \| n > 0 && n < 100} | 0.27 μs | 0.26 μs | 0.27 μs | 0.17 μs | 0.17 μs | 0.09 μs | 0.09 μs | 0.10 μs | 0.09 μs | 0.10 μs |
| set target — :ok → {x \| :ok \| :error} | 0.35 μs | 0.34 μs | 0.35 μs | 0.22 μs | 0.22 μs | 0.13 μs | 0.13 μs | 0.12 μs | 0.12 μs | 0.12 μs |
| count target — String → {s \| count(s) > 0} | 0.17 μs | 0.17 μs | 0.17 μs | 0.11 μs | 0.11 μs | 0.06 μs | 0.05 μs | 0.06 μs | 0.06 μs | 0.06 μs |
| excludedSet — Number → {n \| !=0 && !=1 && !=-1} | 0.47 μs | 0.46 μs | 0.47 μs | 0.33 μs | 0.33 μs | 0.21 μs | 0.22 μs | 0.21 μs | 0.21 μs | 0.21 μs |
| literal source — 50 → {n \| n > 0 && n < 100} | 0.28 μs | 0.28 μs | 0.28 μs | 0.19 μs | 0.18 μs | 0.10 μs | 0.11 μs | 0.11 μs | 0.11 μs | 0.10 μs |
...
| Measurement | `70310733` (2026-05-28) | `8cda5a15` (2026-05-28) | `476a5eef` (2026-05-27) | `90571f50` (2026-05-27) | `90571f50` (2026-05-27) | `dd6cfd53` (2026-05-26) | `9a6c955a` (2026-05-26) | `4b3374b0` (2026-05-26) | `585579cb` (2026-05-26) | `18b49784` (2026-05-26) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 2 stacked refinements | 1.33 μs | 1.30 μs | 1.33 μs | 0.99 μs | 0.98 μs | 0.82 μs | 0.80 μs | 0.80 μs | 0.80 μs | 0.79 μs |
| N= 4 stacked refinements | 5.04 μs | 5.11 μs | 5.16 μs | 4.20 μs | 4.12 μs | 3.45 μs | 3.58 μs | 3.38 μs | 3.54 μs | 3.57 μs |
| N= 8 stacked refinements | 20.91 μs | 20.56 μs | 20.88 μs | 17.51 μs | 17.04 μs | 14.71 μs | 14.75 μs | 14.60 μs | 14.91 μs | 14.49 μs |
| N=16 stacked refinements | 113.62 μs | 110.46 μs | 111.83 μs | 99.20 μs | 97.69 μs | 89.57 μs | 91.04 μs | 90.18 μs | 91.29 μs | 88.93 μs |
| N=32 stacked refinements | 561.85 μs | 547.22 μs | 561.00 μs | 511.75 μs | 501.77 μs | 472.53 μs | 480.82 μs | 472.44 μs | 476.63 μs | 470.92 μs |
...
| Measurement | `70310733` (2026-05-28) | `8cda5a15` (2026-05-28) | `476a5eef` (2026-05-27) | `90571f50` (2026-05-27) | `90571f50` (2026-05-27) | `dd6cfd53` (2026-05-26) | `9a6c955a` (2026-05-26) | `4b3374b0` (2026-05-26) | `585579cb` (2026-05-26) | `18b49784` (2026-05-26) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 10 (parse + simplify) | 32.68 μs | 37.60 μs | 31.94 μs | 29.56 μs | 29.39 μs | 30.28 μs | 29.88 μs | 30.12 μs | 27.72 μs | 27.60 μs |
| N= 50 (parse + simplify) | 198.07 μs | 195.72 μs | 198.06 μs | 184.01 μs | 183.92 μs | 186.58 μs | 187.79 μs | 190.00 μs | 178.93 μs | 175.36 μs |
| N=100 (parse + simplify) | 485.00 μs | 470.31 μs | 483.71 μs | 457.80 μs | 453.05 μs | 454.00 μs | 465.08 μs | 458.94 μs | 460.67 μs | 444.52 μs |
