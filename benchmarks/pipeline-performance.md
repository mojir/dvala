...
| Measurement | `0b2de3d4` (2026-04-25) | `2b915b2a` (2026-04-25) | `b0d06b69` (2026-04-25) | `64d37704` (2026-04-25) | `faca6709` (2026-04-25) | `1adf96dd` (2026-04-25) | `6a9c370a` (2026-04-25) | `caed343e` (2026-04-25) | `62c68940` (2026-04-25) | `d4d3df5f` (2026-04-25) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| interval target — Number → {n \| n > 0 && n < 100} | 0.10 μs | 0.10 μs | 0.10 μs | 0.09 μs | 0.09 μs | 0.10 μs | 0.09 μs | 0.10 μs | 0.10 μs | 0.10 μs |
| set target — :ok → {x \| :ok \| :error} | 0.13 μs | 0.13 μs | 0.13 μs | 0.13 μs | 0.13 μs | 0.13 μs | 0.13 μs | 0.13 μs | 0.12 μs | 0.13 μs |
...
| literal source — 50 → {n \| n > 0 && n < 100} | 0.11 μs | 0.10 μs | 0.11 μs | 0.10 μs | 0.11 μs | 0.11 μs | 0.11 μs | 0.11 μs | 0.10 μs | 0.11 μs |
...
| Measurement | `0b2de3d4` (2026-04-25) | `2b915b2a` (2026-04-25) | `b0d06b69` (2026-04-25) | `64d37704` (2026-04-25) | `faca6709` (2026-04-25) | `1adf96dd` (2026-04-25) | `6a9c370a` (2026-04-25) | `caed343e` (2026-04-25) | `62c68940` (2026-04-25) | `d4d3df5f` (2026-04-25) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 2 stacked refinements | 0.82 μs | 0.85 μs | 0.82 μs | 0.79 μs | 0.80 μs | 0.84 μs | 0.85 μs | 0.84 μs | 0.83 μs | 0.85 μs |
| N= 4 stacked refinements | 3.58 μs | 3.47 μs | 3.53 μs | 3.39 μs | 3.50 μs | 3.54 μs | 3.48 μs | 3.59 μs | 3.52 μs | 3.50 μs |
| N= 8 stacked refinements | 15.28 μs | 15.00 μs | 15.00 μs | 14.71 μs | 15.00 μs | 15.26 μs | 15.09 μs | 15.32 μs | 15.09 μs | 15.18 μs |
| N=16 stacked refinements | 93.33 μs | 92.24 μs | 92.06 μs | 90.52 μs | 92.20 μs | 93.43 μs | 92.64 μs | 93.06 μs | 91.59 μs | 93.39 μs |
| N=32 stacked refinements | 493.62 μs | 486.42 μs | 484.23 μs | 485.47 μs | 490.34 μs | 493.47 μs | 485.23 μs | 494.13 μs | 485.65 μs | 495.02 μs |
...
| Measurement | `0b2de3d4` (2026-04-25) | `2b915b2a` (2026-04-25) | `b0d06b69` (2026-04-25) | `64d37704` (2026-04-25) | `faca6709` (2026-04-25) | `1adf96dd` (2026-04-25) | `6a9c370a` (2026-04-25) | `caed343e` (2026-04-25) | `62c68940` (2026-04-25) | `d4d3df5f` (2026-04-25) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| N= 10 (parse + simplify) | 28.70 μs | 28.46 μs | 28.88 μs | 27.74 μs | 28.96 μs | 28.75 μs | 28.64 μs | 29.02 μs | 29.05 μs | 29.07 μs |
| N= 50 (parse + simplify) | 183.20 μs | 182.91 μs | 182.99 μs | 179.16 μs | 188.17 μs | 184.66 μs | 184.52 μs | 185.46 μs | 186.18 μs | 189.09 μs |
| N=100 (parse + simplify) | 455.16 μs | 454.20 μs | 456.43 μs | 446.47 μs | 484.31 μs | 462.70 μs | 451.86 μs | 458.35 μs | 471.13 μs | 452.79 μs |
