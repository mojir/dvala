...
export const api = {
  ...
  linAlg: [
    ...
    'linear-algebra.normalizeMinmax',
    'linear-algebra.normalizeZscore',
    'linear-algebra.normalizeRobust',
    'linear-algebra.normalizeL1',
    'linear-algebra.normalizeL2',
    'linear-algebra.normalizeLog',
    'linear-algebra.angle',
    'linear-algebra.projection',
    'linear-algebra.isOrthogonal',
    'linear-algebra.isParallel',
    'linear-algebra.isCollinear',
    'linear-algebra.cosineSimilarity',
    'linear-algebra.euclideanDistance',
    'linear-algebra.euclideanNorm',
    'linear-algebra.manhattanDistance',
    'linear-algebra.manhattanNorm',
    'linear-algebra.hammingDistance',
    'linear-algebra.hammingNorm',
    'linear-algebra.chebyshevDistance',
    'linear-algebra.chebyshevNorm',
    'linear-algebra.minkowskiDistance',
    'linear-algebra.minkowskiNorm',
    'linear-algebra.cov',
    'linear-algebra.corr',
    'linear-algebra.spearmanCorr',
    'linear-algebra.pearsonCorr',
    'linear-algebra.kendallTau',
    'linear-algebra.autocorrelation',
    'linear-algebra.crossCorrelation',
    'linear-algebra.rref',
    'linear-algebra.solve',
    'linear-algebra.toPolar',
    'linear-algebra.fromPolar',
  ] as const,
  numberTheory: [
    ...
    'number-theory.countDerangements',
    'number-theory.divisors',
    'number-theory.countDivisors',
    'number-theory.properDivisors',
    'number-theory.countProperDivisors',
    'number-theory.primeFactors',
    'number-theory.countPrimeFactors',
    'number-theory.distinctPrimeFactors',
    'number-theory.countDistinctPrimeFactors',
    'number-theory.factorial',
    'number-theory.partitions',
    'number-theory.countPartitions',
    'number-theory.permutations',
    'number-theory.countPermutations',
    'number-theory.powerSet',
    'number-theory.countPowerSet',
    'number-theory.isCoprime',
    'number-theory.isDivisibleBy',
    'number-theory.gcd',
    'number-theory.lcm',
    'number-theory.multinomial',
    'number-theory.isAmicable',
    'number-theory.eulerTotient',
    'number-theory.mobius',
    'number-theory.mertens',
    'number-theory.sigma',
    'number-theory.carmichaelLambda',
    'number-theory.cartesianProduct',
    'number-theory.perfectPower',
    'number-theory.modExp',
    'number-theory.modInv',
    'number-theory.extendedGcd',
    'number-theory.chineseRemainder',
    'number-theory.stirlingFirst',
    'number-theory.stirlingSecond',
  ] as const,
  convert: [
    'convert.angstrom->um',
    'convert.angstrom->mm',
