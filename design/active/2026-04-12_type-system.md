...
| 24 | Rest parameter types (deferred) | `(Number, ...Number[]) -> Number` | Variadic function params. Needs `constrain` to handle rest params — currently capped at 3-arg overloads via intersection. Required for `+`, `*`, `++`, etc. |
